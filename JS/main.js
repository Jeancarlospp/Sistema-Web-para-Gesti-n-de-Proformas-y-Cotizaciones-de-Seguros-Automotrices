...
function runPageSpecificLogic() {
    ...
    else if (path.includes('visualizar_productos.html')) loadVisualizarProductos();
    else if (path.includes('productos_asegurables.html')) loadProductosAsegurables();
    else if (path.includes('reportes_auditoria.html')) loadReportesAuditoria();
    else if (path.includes('supervisar_cotizaciones.html')) loadSupervisarCotizaciones();
