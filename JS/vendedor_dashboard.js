...
function showMessage(message, isError = false, container) {
  container.innerHTML = `<p class="text-${
...
export function loadVendedorDashboard() {
  console.log(
    "Módulo del Dashboard del Vendedor (sincronizado con SQL) cargado."
  );
  ...
  const clientNameDisplay = document.getElementById(
    "vendedor-client-name-display"
  );
