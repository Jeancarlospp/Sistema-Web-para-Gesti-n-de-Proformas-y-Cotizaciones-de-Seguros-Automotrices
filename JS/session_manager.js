...
class SessionManager {
  ...
  createWarningModal() {
    ...
    this.warningModal = new bootstrap.Modal(
      document.getElementById("session-warning-modal")
    );
  }
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (!isLoginPage && !window.sessionManager) {
    window.sessionManager = new SessionManager(5); // 15 minutos de inactividad
    console.log(
      "Sistema de control de sesiones por inactividad iniciado - Timeout: 55 minutos"
    );
  }
});
